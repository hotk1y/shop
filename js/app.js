(() => {
    ...
    (() => {
        ...
        da.init();
        if (isMobile.any()) {
            let menuParents = document.querySelectorAll(".menu-page__list>li>a");
            ...
            let menuParents = document.querySelectorAll(".menu-page__list>li");
            for (let index = 0; index < menuParents.length; index++) {
                const menuParent = menuParents[index];
        ...
        let checkboxCategory = document.querySelectorAll(".category-search__checkbox");
        for (let index = 0; index < checkboxCategory.length; index++) {
            const checkboxCategor = checkboxCategory[index];
            checkboxCategor.addEventListener("change", (function(e) {
                checkboxCategor.classList.toggle("_active");
                let checkboxActiveCategory = document.querySelectorAll(".category-search__checkbox._active");
                ...
                } else searchSelect.classList.remove("_category");
            }));
        }
        window["FLS"] = true;
        isWebp();
